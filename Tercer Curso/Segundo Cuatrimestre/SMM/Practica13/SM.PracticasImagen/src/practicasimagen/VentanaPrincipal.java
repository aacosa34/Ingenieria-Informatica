...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(barraHerramientas, java.awt.BorderLayout.NORTH);

        jToolBar1.setRollover(true);

        botonReproducir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/play24x24.png"))); // NOI18N
        ...
        botonDetener.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/stop24x24.png"))); // NOI18N
        ...
        listaPistas.setPreferredSize(new java.awt.Dimension(200, 24));
        jToolBar1.add(listaPistas);
    ...
    private void menuAbrirAudioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuAbrirAudioActionPerformed
        ...
        if (resp == JFileChooser.APPROVE_OPTION) {
            try {
                // Creamos una clase anonima con el objetivo de que se devuelva
                // solo el nombre del fichero y no su ruta
                ...
                this.listaPistas.addItem(f);
                this.listaPistas.setSelectedItem(f);
            } catch (Exception ex) {
                System.err.println("Error al abrir el sonido");
            }
        }
    ...
    private void botonReproducirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonReproducirActionPerformed
        File f = (File) listaPistas.getSelectedItem();
        if (f != null) {
