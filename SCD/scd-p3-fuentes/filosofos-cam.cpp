...
void funcion_filosofos( int id )
{
  ...
  while ( true )
  {
    ...
    MPI_Ssend(&peticion, 1, MPI_INT, num_procesos - 1, etiq_sentarse, MPI_COMM_WORLD);
    ...
    MPI_Ssend(&peticion, 1, MPI_INT, num_procesos - 1, etiq_levantarse, MPI_COMM_WORLD);
    cout <<"Filósofo " <<id << " se levanta en la mesa." << endl;
