...
/**
  * @brief Expresa un racional en su valor real
  * @return Devuelve el valor real del racional
*/
  double real();
...
/**
  ...
  * @param r racional a restar con el objeto implícito
*/
  Racional operator-(const Racional & r);
...
/**
  ...
  * @param r racional a dividir con el objeto implícito
*/
  Racional operator/(const Racional & r);
